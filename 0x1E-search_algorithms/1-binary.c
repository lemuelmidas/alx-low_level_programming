...
/**
 * binary_search - a function to use binary search to find a number in an array
...
/**
 * bin_search_recursive - a function to recursively use binary search to find a number
 * @array: pointer to first element in array to search
 * @start: start index
 * @end: end index
 * @value: value to find
